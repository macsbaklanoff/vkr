...
namespace VKR_server.Migrations
{
    ...
    [Migration("20250601180510_ChangeTypeFieldEstRecommendationsInEstTable")]
    partial class ChangeTypeFieldEstRecommendationsInEstTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VKR_server.DB.Entities.Estimation", b =>
                {
                    ...
                    b.Property<string>("EstRecommedations")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("est_recommendations");
